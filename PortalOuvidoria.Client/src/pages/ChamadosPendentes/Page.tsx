...
import { ChamadoCompletoResponse, usePendingChamadosQuery } from "@/api/chamadoApi";
...
export function ChamadosPendentesPage() {
  const { data, isLoading, error } = usePendingChamadosQuery();
...
export default ChamadosPendentesPage;