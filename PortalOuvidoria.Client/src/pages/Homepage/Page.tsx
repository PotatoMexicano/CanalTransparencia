...
export default function HomePage() {
  ...
  const initialTab = searchParams.get("tab") || "registrar";
        ...
        <div className='flex min-h-screen w-screen z-10'>
          <div className="m-auto">
            ...
            <div className="flex m-auto justify-center">
              <Tabs defaultValue={initialTab} className="w-full p-4 md:p-0 md:w-[500px]">
                <TabsList className="grid w-full grid-cols-2 my-5">
                  <TabsTrigger value="registrar">Novo chamado</TabsTrigger>
