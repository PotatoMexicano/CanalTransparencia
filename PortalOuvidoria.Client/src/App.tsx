      ...
      <Provider store={store}>
        <ThemeProvider defaultTheme="light" storageKey="vite-ui-theme">
          <div className="min-h-screen w-full relative flex items-center justify-center bg-grid-black/[0.05] dark:bg-grid-white/[0.2] dark:bg-black">
            <div className="fixed pointer-events-none inset-0 flex items-center justify-center bg-white dark:bg-black z-0 [mask-image:radial-gradient(ellipse_at_center,transparent_10%,black)]"></div>
  
            <div className='flex min-h-screen w-screen z-10'>
